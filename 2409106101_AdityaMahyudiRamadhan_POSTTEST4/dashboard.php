...
<head>
    ...
    <title>Dasboard PT. Ebos Group</title>

    <link rel="stylesheet" href="2409106101_AdityaMahyudiRamadhan_POSTTEST4.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="2409106101_AdityaMahyudiRamadhan_POSTTEST4.js">
    </head>

<body>

    <header>
        <h1>Dasboard PT. Ebos Group</h1>
        <p>Selamat datang, **<?php echo $username; ?>**! | <a href="logout.php">Logout</a></p>
    ...
    <main>
        ...
        <div class="table-container">
            ...
            <button id="loadDataBtn" class="btn">Ambil Data dari API</button>
    ...
    <script src="2409106101_AdityaMahyudiRamadhan_POSTTEST4.js" defer></script>
</body>
</html>